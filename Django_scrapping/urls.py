"""DjangoScrapping URL Configuration
...
#     url(r'^', include("scrapping_app.urls")),
...
admin.site.site_header = 'DjangoScrapping Admin'
admin.site.site_title = 'DjangoScrapping Administration'
admin.site.index_title = 'DjangoScrapping Administration'
